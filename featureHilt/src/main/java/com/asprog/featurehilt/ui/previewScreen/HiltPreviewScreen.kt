package com.asprog.featurehilt.ui.previewScreen
...
import com.asprog.featurehilt.ui.innerScreen.HiltInnerActivity
import com.baseapp.base_ui_kit.scaffold.BaseTopBar

@ExperimentalAnimationApi
@Composable
fun HiltPreviewScreen() {
    val context = LocalContext.current

    val i = Intent(context, HiltInnerActivity::class.java)
